...
var Carousel = exports.Carousel = function () {
	...
	_createClass(Carousel, [{
		...
		value: function updateProduct() {
			...
			(0, _jquery2.default)('#' + this.product["productId"]).append('<button type="button">Add to Cart</button>');
		}
	}]);
...
},{"Wallop":1,"jquery":2}],5:[function(require,module,exports){
"use strict";
...
var App = function () {
	...
	_createClass(App, [{
		key: "getUrl",
		value: function getUrl(category) {
			var categoryId = 'abcat0502000';
			var url = this.baseUrl + "((categoryPath.id=" + categoryId + "))";
		...
		value: function initBBCall() {
			...
			(0, _bestbuy2.default)({ url: this.getUrl('laptop'), api: this.apiKey }).then(function (data) {
