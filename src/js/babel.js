...
},{"./flickity":8,"fizzy-ui-utils":3,"unidragger":18}],8:[function(require,module,exports){
// Flickity main
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":8,"fizzy-ui-utils":3,"tap-listener":17}],12:[function(require,module,exports){
// player & autoPlay
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"./flickity":8,"fizzy-ui-utils":3,"tap-listener":17}],14:[function(require,module,exports){
// slide
( function( window, factory ) {
  // universal module definition
  /* jshint strict: false */
...
},{"unipointer":19}],18:[function(require,module,exports){
/*!
 * Unidragger v2.2.3
...
},{"ev-emitter":2}],20:[function(require,module,exports){
'use strict';
...
var Carousel = exports.Carousel = function () {
	...
	_createClass(Carousel, [{
		...
		value: function updateProduct() {
			...
			(0, _jquery2.default)('#' + this.product["productId"]).append('<p></p>');
			(0, _jquery2.default)('#' + this.product["productId"] + ' p:eq(1)').html(this.product["item"].includedItemList[0].includedItem);
			(0, _jquery2.default)('#' + this.product["productId"]).append('<img />');
...
},{"flickity":9,"jquery":16}],22:[function(require,module,exports){
"use strict";
...
var _produtil = require("./produtil");
...
var App = function () {
	...
	_createClass(App, [{
		...
		value: function getUrl() {
			...
			var url = this.baseUrl + "((categoryPath.id=" + this.categoryId + "))";
		...
		value: function cartEventListen() {
			(0, _jquery2.default)(".cart-desktop").on("click", function (x) {
				...
				for (var i = 0; i < sessionStorage.length; i++) {
					...
					(0, _jquery2.default)('.modal-body').append('<div id="' + lineNo + '" class="modal-item flex"><div>' + "SKU : " + skuKey + "</div><div>PRICE : $" + cartObj.price + "</div><div>QUANTITY : " + cartObj.qty + "</div><div>TOTAL : $" + cartObj.total + '</div></div>');
...
},{"./bestbuy":20,"./carousel":21,"./produtil":23,"jquery":16}],23:[function(require,module,exports){
"use strict";
